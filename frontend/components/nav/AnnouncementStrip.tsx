...
export function AnnouncementStrip() {
  ...
  return (
    <div className="bg-strong-accent text-white text-sm">
      <div className="mx-auto max-w-content px-md lg:px-2xl h-9 flex items-center justify-center gap-md">
        ...
        <span
          aria-live="polite"
          className="hidden md:inline-flex items-center gap-1 px-sm py-xs rounded-pill bg-white/15 tabular-nums text-xs font-bold"
        >
          {countdownPadded}
        </span>
      </div>
