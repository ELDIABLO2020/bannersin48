              ...
              {ACTIONS.map((a) => {
                ...
                return (
                  <Link
                    key={a.href}
                    href={a.href}
                    className="qa-card group block min-h-[190px] rounded-feature border border-line bg-surface p-lg shadow-elev-1 no-underline transition-all hover:-translate-y-1 hover:border-strong-accent hover:shadow-elev-2"
                    aria-label={a.label}
                  >
                    <div className="flex h-full flex-col">
                      <span className="inline-flex h-12 w-12 items-center justify-center rounded-feature bg-soft-accent text-strong-accent">
                      ...
                      <span className="mt-auto pt-lg inline-flex items-center gap-xs text-sm font-bold text-strong-accent">
                        Continue
                        <ArrowRight
        ...
        <div className="mt-3xl overflow-hidden rounded-feature border border-line bg-surface shadow-elev-2">
          <div className="grid grid-cols-1 lg:grid-cols-[1.1fr_0.9fr]">
            <div className="p-xl sm:p-2xl">
              <p className="text-sm font-semibold text-strong-accent">Banner-ready artwork</p>
              <h3 className="mt-sm font-display font-extrabold tracking-tight text-[34px] leading-tight text-ink">
