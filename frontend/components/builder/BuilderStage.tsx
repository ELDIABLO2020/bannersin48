...
export function BuilderStage() {
  ...
  return (
    <div
      ...
      className="relative grid h-full min-h-[280px] w-full overflow-hidden rounded-feature border border-line bg-surface shadow-[0_12px_40px_-24px_rgba(0,0,0,0.35)]"
      style={{
    ...
    >
      ...
      <div
        ref={pasteboardRef}
        className="relative min-h-0 min-w-0 overflow-hidden bg-surface-tint"
      >
        {layout.creativeW > 0 && (
          <div
