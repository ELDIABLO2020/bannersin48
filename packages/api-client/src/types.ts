/**
 * API request/response types, hand-written against @bannersin48/shared.
 */
...
/** A published CMS block from GET /content (authored in the admin content editor). */
export interface ContentBlock {
  key: string;
  blockType: "BANNER_IMAGE" | "TEXT" | "ANNOUNCEMENT" | "PROMO_STRIP";
